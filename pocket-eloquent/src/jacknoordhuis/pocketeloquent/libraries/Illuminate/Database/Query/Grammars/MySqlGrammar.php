...
namespace jacknoordhuis\pocketeloquent\libraries\Illuminate\Database\Query\Grammars;
...
use jacknoordhuis\pocketeloquent\libraries\Illuminate\Database\Query\Builder;
use jacknoordhuis\pocketeloquent\libraries\Illuminate\Database\Query\JsonExpression;
...
class MySqlGrammar extends Grammar
{
     ...
     *
     * @param  string  $key
     * @param  \jacknoordhuis\pocketeloquent\libraries\Illuminate\Database\Query\JsonExpression  $value
     * @return string
     */
