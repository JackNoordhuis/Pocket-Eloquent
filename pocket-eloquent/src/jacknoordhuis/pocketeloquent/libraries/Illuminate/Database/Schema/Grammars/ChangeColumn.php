...
use jacknoordhuis\pocketeloquent\libraries\Doctrine\DBAL\Types\Type;
use jacknoordhuis\pocketeloquent\libraries\Illuminate\Support\Fluent;
use jacknoordhuis\pocketeloquent\libraries\Doctrine\DBAL\Schema\Table;
use jacknoordhuis\pocketeloquent\libraries\Illuminate\Database\Connection;
use jacknoordhuis\pocketeloquent\libraries\Doctrine\DBAL\Schema\Comparator;
...
class ChangeColumn
{
     ...
     *
     * @param  \Doctrine\DBAL\Schema\Table  $table
     * @param  \jacknoordhuis\pocketeloquent\libraries\Illuminate\Support\Fluent  $fluent
